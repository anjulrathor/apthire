        ...
        <div className="max-w-3xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-[#111] p-8 rounded-xl border border-white/10">
                ...
                <div className="grid grid-cols-3 gap-4">
                    ...
                    <div>
                        <label className="block text-sm font-bold text-gray-400 mb-2">Experience</label>
                        <input name="experience" required onChange={handleChange} className="w-full bg-[#0d0d0d] border border-white/10 rounded px-3 py-2 outline-none focus:border-emerald-500" placeholder="e.g. 3-5 Years" />
                    </div>
                    <div>
