  ...
  return (
    <>
      ...
      <button 
        ...
        className="md:hidden fixed top-4 left-4 z-[60] p-2 bg-[#0d0d0d] border border-white/10 rounded-lg text-white shadow-xl"
      >
      ...
      <aside className={`w-64 bg-[#0d0d0d] border-r border-white/10 h-screen flex flex-col fixed left-0 top-0 z-50 shadow-2xl transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0`}>
